...
public class Data_Security extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent in = new Intent(Data_Security.this, Topic_Common.class);
        in.putExtra("TOPIC",2);
        ...
        switch(number){
            case 0:
                ...
                topic_table = "What is Data Security?";
                break;
            case 1:
