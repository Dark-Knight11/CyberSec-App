...
public class Topic_WAPT_Security extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wapt_security_topic);
        ...
        back.setOnClickListener(v -> startActivity(new Intent(Topic_WAPT_Security.this, MainActivity.class)));
